...
import type { ActivityEvent, IssueAttachment } from "@openblock/shared";
...
export function IssueDetail() {
  ...
  const { data: linkedApprovals } = useQuery({
    ...
    queryFn: () => issuesApi.listApprovals(issueId!) as Promise<Approval[]>,
    enabled: !!issueId,
  });
  ...
  const agentMap = useMemo(() => new Map<string, Agent>(), []);
      ...
      <Tabs value={detailTab} onValueChange={setDetailTab} className="space-y-3">
        ...
        <TabsContent value="comments">
          <CommentThread
            ...
            agentMap={agentMap}
            draftKey={`openblock:issue-comment-draft:${issue.id}`}
            enableReassign
