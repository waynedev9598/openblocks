import type { Issue, IssueAttachment, IssueComment, IssueLabel } from "@openblock/shared";
...
export const issuesApi = {
  ...
  listApprovals: (id: string) => api.get<unknown[]>(`/issues/${id}/approvals`),
  linkApproval: (id: string, approvalId: string) =>
    api.post<unknown[]>(`/issues/${id}/approvals`, { approvalId }),
