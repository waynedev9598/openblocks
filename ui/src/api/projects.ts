import type { Project } from "@openblock/shared";
...
export const projectsApi = {
  ...
  listWorkspaces: (projectId: string, companyId?: string) =>
    api.get<unknown[]>(projectPath(projectId, companyId, "/workspaces")),
  createWorkspace: (projectId: string, data: Record<string, unknown>, companyId?: string) =>
    api.post<unknown>(projectPath(projectId, companyId, "/workspaces"), data),
  ...
  removeWorkspace: (projectId: string, workspaceId: string, companyId?: string) =>
    api.delete<unknown>(projectPath(projectId, companyId, `/workspaces/${encodeURIComponent(workspaceId)}`)),
