...
import { buildProjectMentionHref, parseProjectMentionHref } from "@openblock/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("openblock-project-mention-chip");
      ...
      link.classList.add("openblock-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative openblock-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("openblock-mdxeditor", !bordered && "openblock-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "openblock-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
