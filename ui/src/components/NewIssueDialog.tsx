...
const DRAFT_KEY = "openblock:issue-draft";
...
export function NewIssueDialog() {
  ...
  const assigneeAdapterType: string | null = null;
  ...
  const assigneeAdapterModels: never[] | undefined = undefined;
  ...
  const currentAssignee = agents.find((a: { id: string }) => a.id === assigneeId);
